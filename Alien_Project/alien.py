...
class Alien(Sprite):
    ...
    alien_images0 = [pg.transform.rotozoom(pg.image.load(f'images/alien{n}.bmp'), 0, 0.7) for n in range(4, 6)]
    alien_images1 = [pg.transform.rotozoom(pg.image.load(f'images/alien{n}.bmp'), 0, 0.7) for n in range(2, 4)]
    alien_images2 = [pg.transform.rotozoom(pg.image.load(f'images/alien{n}.bmp'), 0, 0.7) for n in range(2)]
    ufo_images0 = [pg.transform.rotozoom(pg.image.load(f'images/ufo{n}.bmp'), 0.7, 0.7) for n in range(2)]
    ...
    alien_timers = {0: Timer(image_list=alien_images0),
                    ...
                    4: Timer(image_list=ufo_images0)}
    ...
    def __init__(self, game, type):
        ...
        self.ufo_image = pg.image.load('images/ufo0.bmp')
...
class Aliens:
    ...
    def create_ufo(self):
        ...
        alien = Alien(game=self.game, type=type)
        alien_width = alien.rect.width
        alien.x = alien_width + 2.5 * alien_width
        alien.rect.y = alien.rect.height + 0.5 * alien.rect.height
        self.aliens.add(alien)
